...
public class UnitImpl<F extends Enum<F> & FundamentalUnitType<F>> implements Unit<F> {
    ...
    public static <F extends Enum<F> & FundamentalUnitType<F>> Unit<F> newBaseUnit(UnitType<F> unitType) {
