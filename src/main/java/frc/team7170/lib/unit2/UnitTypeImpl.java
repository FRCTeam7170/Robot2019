...
public class UnitTypeImpl<F extends Enum<F> & FundamentalUnitType<F>> implements UnitType<F> {

    public static class Builder<F extends Enum<F> & FundamentalUnitType<F>> {
