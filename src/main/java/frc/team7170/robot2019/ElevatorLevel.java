...
public enum ElevatorLevel {
    LEVEL1(Constants.Elevator.LEVEL1_METRES, Constants.Drive.LEVEL1_MULTIPLIER),
    LEVEL2(Constants.Elevator.LEVEL2_METRES, Constants.Drive.LEVEL2_MULTIPLIER),
    LEVEL3(Constants.Elevator.LEVEL3_METRES, Constants.Drive.LEVEL3_MULTIPLIER);
